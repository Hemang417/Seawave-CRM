...
<div>
    ...
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">SB Filed</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">SB Receipt</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Assessed</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Goods Receipt</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Carted</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Examined</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">LEO</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Stuffing</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Handover to Carrier</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">Loaded</label>
    <label for="job_received_on" class="block mb-2 text-sm font-xs text-gray-900 dark:text-white">BL Release</label>
