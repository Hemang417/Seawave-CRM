...
<div classname= "parent">
  <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div>
              ...
              <input type="text" id="first_name" class=" w-32 h-8 mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Job No./BL No." />
